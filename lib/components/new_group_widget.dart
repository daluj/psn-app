                    ...
                    Padding(
                      ...
                      child: FutureBuilder<List<GetProjectsRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final dropDownGetProjectsRowList = snapshot.data!;

                          return FlutterFlowDropDown<int>(
                            controller: _model.dropDownValueController ??=
                                FormFieldController<int>(
                              _model.dropDownValue ??=
                                  dropDownGetProjectsRowList
                                      .firstOrNull?.projectId,
                            ),
                            options: List<int>.from(dropDownGetProjectsRowList
                                .map((e) => e.projectId)
                                .toList()),
                            optionLabels: dropDownGetProjectsRowList
                                .map((e) => e.name)
                                .toList(),
                            onChanged: (val) =>
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await SQLiteManager.instance.newGroup(
                            name: _model.groupNameTextController.text,
                            projectId: _model.dropDownValue!,
                          );
