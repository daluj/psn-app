...
import '/components/set_attendance_widget.dart';
...
class StaffMenuWidget extends StatefulWidget {
  const StaffMenuWidget({
    super.key,
    required this.staff,
  });

  final GetStaffRow? staff;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (FFAppState().userProject.id != -1)
              InkWell(
                splashColor: Colors.transparent,
                focusColor: Colors.transparent,
                hoverColor: Colors.transparent,
                    ...
                    builder: (context) {
                      return Padding(
                        ...
                        child: Container(
                          ...
                          child: SetAttendanceWidget(
                            personId: widget!.staff!.staffId,
                            personType: PersonType.staff.name,
                          ),
                        ),
                      );
                    },
            ...
            InkWell(
              ...
              onTap: () async {
                ...
                if (confirmDialogResponse) {
                  await SQLiteManager.instance.deleteStaff(
