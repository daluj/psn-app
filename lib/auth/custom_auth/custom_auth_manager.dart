...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    psncamboyaAuthUserSubject.add(
      PsncamboyaAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PsncamboyaAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PsncamboyaAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PsncamboyaAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    psncamboyaAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
PsncamboyaAuthUser? currentUser;
